...
<!-- Mirrored from zubuz.netlify.app/single-portfolio by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Aug 2024 09:06:41 GMT -->
...
<body id="body" class="light-mode">
  ...
  <div class="zubuz-breadcrumb">
    <div class="container">
      <h1 class="post__title">Portfolio Details</h1>
    ...
    <div class="container">
      <div class="zubuz-section-title zubuz-two-column-title">
        <div class="row">
          ...
          <div class="col-lg-5 d-flex align-items-center">
            <p>E-commerce is a method of buying & selling goods and services online. It can use e-commerce channel such as your own website, an established selling.</p>
          </div>
        </div>
      </div>
      ...
      <div class="zubuz-portfolio-info">
        ...
        <div class="zubuz-portfolio-info-item">
          <p>Website</p>
          <a href="#">
            <h3>Live preview <img src="assets/images/icon/arrow-right.svg" alt=""></h3>
          </a>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-8">
          <div class="zubuz-portfolio-details-content-wrap">
            <div class="zubuz-portfolio-details-content">
              ...
              <p>Web design platforms can be subscription-based or non-subscription-based. Furthermore, different platforms have different features aimed at specific parts of the market. For example: Platforms such as Magento and Shopify are geared towards ecommerce websites.</p>
            </div>
            <div class="zubuz-portfolio-details-content">
              <h2>Project execution:</h2>
              <p>Let's choose the average value and look at the following seven steps of web development: Information Gathering, Planning, Design, Content Writing and Assembly, Coding, Testing, Review and Launch, as well as Maintenance.</p>
              <h4>The 6 Steps of the Website Design Process:</h4>
              <ul>
                <li>Step 1: Discovery Phase. It's impossible to complete a successful website design process without first knowing what the goals of the project are</li>
        ...
        <div class="col-lg-4">
          <div class="zubuz-portfolio-details-thumb-wrap">
            <div class="zubuz-portfolio-details-thumb-item">
              <img src="assets/images/portfolio/p-details1.png" alt="">
            </div>
            <div class="zubuz-portfolio-details-thumb-item">
              <img src="assets/images/portfolio/p-details2.png" alt="">
            </div>
            <div class="zubuz-portfolio-details-thumb-item">
              <img src="assets/images/portfolio/p-details3.png" alt="">
            </div>
          </div>
        </div>
      </div>
...
<!-- Mirrored from zubuz.netlify.app/single-portfolio by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Aug 2024 09:06:49 GMT -->
</html>