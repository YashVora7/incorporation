...
<!-- Mirrored from zubuz.netlify.app/single-service by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Aug 2024 09:06:13 GMT -->
...
<body id="body" class="light-mode">
  ...
  <div class="zubuz-breadcrumb">
    <div class="container">
      <h1 class="post__title">Services Details</h1>
      <nav class="breadcrumbs">
        <ul>
          <li><a href='index.html'>Home</a></li>
          <li aria-current="page"> Services Details</li>
        </ul>
      </nav>
  ...
  <div class="section zubuz-section-padding">
    <div class="container">
      <div class="zubuz-section-title center">
        <h2 class="rt-mb-20">Welcome to our customer support</h2>
        <p>Customer support service refers to the assistance and also guidance provided to customers before, after the purchase or use our service.</p>
      </div>
      <div class="zubuz-video-wrap m-0">
        <img src="assets/images/service/video-bg.png" alt="">
        <a class="video-init zubuz-review-video zubuz-video-service" href="https://www.youtube.com/watch?v=SixdAQtWJQ8">
          <img class="video-sevice" src="assets/images/service/play-btn.svg" alt="">
      ...
      <div class="row">
        <div class="col-lg-7">
          <div class="zubuz-default-content m-right-50">
            ...
            <p>Our Customer support service, where exceptional assistance is not just a promise but a commitment to your satisfaction. Effective all our customer support is crucial for building trust.</p>
            <p>Our dedicated team is here to provide all comprehensive support, ensuring a seamless experience for every user cordially.</p>
          </div>
        </div>
        <div class="col-lg-5">
          <div class="zubuz-default-content">
            <div class="zubuz-iconbox-wrap-left mw-100">
              ...
              <div class="zubuz-iconbox-data data-small">
                ...
                <p>Reach us through various channels, including live chat email, live chat, and also phone, providing flexibility.</p>
              </div>
            </div>
            <div class="zubuz-iconbox-wrap-left mw-100">
              <div class="zubuz-iconbox-icon none-bg">
              ...
              <div class="zubuz-iconbox-data data-small">
                ...
                <p>Comprehensive knowledge base is at your fingertips, it offering self-help resources, FAQs, and tutorials.</p>
              </div>
            </div>
            <div class="zubuz-iconbox-wrap-left mw-100">
              <div class="zubuz-iconbox-icon none-bg">
              ...
              <div class="zubuz-iconbox-data data-small">
                ...
                <p>Our proactive approach ensures that potential issues are identified ensuring a smooth & uninterrupted.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="section zubuz-section-padding2 bg-light">
    <div class="container">
      <div class="zubuz-section-title center">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="zubuz-testimonial-wrap">
            <div class="zubuz-testimonial-rating">
              <ul>
                <li><img src="assets/images/icon/star-green.svg" alt=""></li>
                <li><img src="assets/images/icon/star-green.svg" alt=""></li>
                <li><img src="assets/images/icon/star-green.svg" alt=""></li>
                <li><img src="assets/images/icon/star-green.svg" alt=""></li>
                <li><img src="assets/images/icon/star-green.svg" alt=""></li>
            ...
            <div class="zubuz-testimonial-author">
              <div class="zubuz-testimonial-author-thumb">
                <img src="assets/images/v1/t_user1.png" alt="">
              </div>
        ...
        <div class="col-lg-6">
          <div class="zubuz-testimonial-wrap">
            ...
            <div class="zubuz-testimonial-author">
              <div class="zubuz-testimonial-author-thumb">
                <img src="assets/images/v1/t_user2.png" alt="">
              </div>
              <div class="zubuz-testimonial-author-data">
        ...
        <div class="col-lg-6">
          <div class="zubuz-testimonial-wrap">
            ...
            <div class="zubuz-testimonial-author">
              <div class="zubuz-testimonial-author-thumb">
                <img src="assets/images/v1/t_user3.png" alt="">
              </div>
              <div class="zubuz-testimonial-author-data">
        ...
        <div class="col-lg-6">
          <div class="zubuz-testimonial-wrap">
            ...
            <div class="zubuz-testimonial-author">
              <div class="zubuz-testimonial-author-thumb">
                <img src="assets/images/v1/t_user4.png" alt="">
              </div>
              <div class="zubuz-testimonial-author-data">
      ...
      <div class="zubuz-testimonial-btn">
        <a class='zubuz-default-btn' href='testimonials.html'>
...
<!-- Mirrored from zubuz.netlify.app/single-service by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Aug 2024 09:06:18 GMT -->
</html>