...
if (isset($_GET['en_id'])) {
    ...
    if ($response === false) {
        ...
        $uploadDir = __DIR__ . '/upload_form_45b_verify/';
        ...
        $stmt = $link->prepare("UPDATE staff_assignments SET secretary_sign_form45b_doc = ?, secretary_sign_form45b = ? WHERE id = ?");
        ...
        if ($stmt->execute()) {
            ...
            header("Location: " . $baseUrl . "/incorporation/before-incorporation/form-45b/");
        } else {
