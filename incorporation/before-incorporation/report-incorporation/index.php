            ...
            <div class="main-content">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Report-Incorporation</li>
                  </ol>
                </nav>
                <section class="section">
                    <p class="fw-bold mb-2 font-20 text-black">Report-Incorporation</p>
                    <br>
                                ...
                                <?php if (isset($_SESSION['company_id'])) {
                                    while ($row = $excute->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($row['verify_sign_flag_report_incorporation_pdf'] == 1): ?>
                                            ...
                                            <td>
                                                <?php if($row['verify_sign_flag_report_incorporation_pdf'] == 1): ?>
                                                    <a href="<?php echo $baseUrl . "incorporation/before-incorporation/report-incorporation/upload_verify_report_ipdf_form/" . $row['verify_sign_document_report_incorporation_pdf']; ?>" target="_blank">
                                            ...
                                            <td>
                                                ...
                                                <?php else: ?>
                                                    <a href="report_rdf/<?php echo $row['id']; ?>" class="btn btn-danger">Sign Now</a>
                                                <?php endif;?>
                                            </td>
                                        </tr>
                                    <?php endwhile;
