...
<body>
    ...
    if (isset($_GET['enid'])) {
        ...
        if ($response === false) {
            ...
            $uploadDir = __DIR__ . '/upload_verify_report_ipdf_form/';
            ...
            $stmt = $link->prepare("UPDATE officer SET verify_sign_document_report_incorporation_pdf = ?, verify_sign_flag_report_incorporation_pdf = ? WHERE cr_id = '$company_id' ");
