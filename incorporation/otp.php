...
<head>
    <base href="<?php echo $baseUrl; ?>/incorporation/">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form name="" action="" method="POST">
                                    ...
                                    <input style="display: none;" type="text" name="" id="user_id" value="<?php echo $user_id; ?>">
    ...
    <script>
        ...
        $('#submit_pass').click(function() {
            ...
            if (pass != cpass) {
                ...
                $.ajax({
                    type: "POST",
                    url: "api/update_password_api.php",
                    data: {
                        user_id: user_id,
                        new_pass: pass,
                    },
                    ...
                    success: function(data) {
                        ...
                        if (result.error_flag == 0) {
                            swal.fire({
                                ...
                                if (isConfirm.value) {
                                    window.location = '<?php echo $baseUrl; ?>/incorporation/auth-login';
                                } else {
