...
<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav navbar-right">
        <?php if ($user_data['email'] == 'superadminswtch@gmail.com' && $user_data['password'] == 'Super@123') :?>
        <li>
            <button id="switch_button"  class="btn btn-primary float-end my-2">Switch To Super Admin</button>
        </li>
          <?php endif;?>
 ...
 <script>
        ...
        $(document).ready(function () {
            $('#switch_button').click(function () {
                ...
                let email = 'adminf@gmail.com';
                let password = 'offerz@2580';
